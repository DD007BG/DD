...
uint8_t USART2_RX_BUF[ATK_MW8266D_UART_RX_BUF_SIZE];
uint8_t  USART2_TX_BUF[ATK_MW8266D_UART_TX_BUF_SIZE];
uint16_t USART2_RX_STA = 0;

UART_HandleTypeDef huart2;                    /* ATK-MW8266D UART */
static struct
{
...
{
    huart2.Instance          = ATK_MW8266D_UART_INTERFACE;   /* ATK-MW8266D UART */
    ...
    HAL_UART_Init(&huart2);                                  /* 使能ATK-MW8266D UART
